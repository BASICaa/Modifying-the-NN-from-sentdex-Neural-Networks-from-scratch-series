...
for frame in range(100000):
    for batch_start in range(0, len(X), batch_size):
        ...
        accuracy_history.append(highest_accuracy)
        loss_history.append(lowest_loss)
        frame_accuracy_data.append((frame, highest_accuracy))
        frame_loss_data.append((frame, lowest_loss))

ax1.plot([data[0] for data in frame_accuracy_data], [data[1] for data in frame_accuracy_data], label='Accuracy', color='b', marker='o')
ax1.set_xlabel('Frame')
ax1.set_ylabel('Accuracy')
ax1.legend()

ax2.plot([data[0] for data in frame_loss_data], [data[1] for data in frame_loss_data], label='Loss', color='r', marker='s')
